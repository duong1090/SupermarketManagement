    ...
    public partial class AddtoDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OperatingID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Detail = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Operatings", x => x.OperatingID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Receipt_DetailID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    ImportReceiptID = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Receipt_Details", x => x.Receipt_DetailID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RoleID = table.Column<int>(nullable: false),
                    OperatingID = table.Column<int>(nullable: false),
                    Alow = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoleAllows", x => new { x.RoleID, x.OperatingID });
                    table.UniqueConstraint("AK_RoleAllows_OperatingID_RoleID", x => new { x.OperatingID, x.RoleID });
                    table.ForeignKey(
                        name: "FK_RoleAllows_Operatings_OperatingID",
                        column: x => x.OperatingID,
                        principalTable: "Operatings",
                        principalColumn: "OperatingID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoleAllows_Roles_RoleID",
                        column: x => x.RoleID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ImportReceipts_Staffs_StaffID",
                        column: x => x.StaffID,
                        principalTable: "Staffs",
                        principalColumn: "StaffID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Bill_DetailID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    ProductID = table.Column<int>(nullable: false),
                    BillID = table.Column<int>(nullable: false),
                    TotalPrie = table.Column<float>(nullable: false),
                    ProductAmount = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bill_Details", x => x.Bill_DetailID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<bool>(nullable: false),
                    Bill_DetailID = table.Column<int>(nullable: true),
                    Receipt_DetailID = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
